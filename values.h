...
typedef struct {
    ...
    size_t body_count;
    Environment *env;
    RuntimeVal *(*builtin_func)(Environment *env, RuntimeVal **args, size_t arg_count);
} FunctionVal;
...
typedef RuntimeVal *(*NativeFn)(Environment *env, RuntimeVal **args, int arg_count);
...
#define MK_NATIVE_FN(params, param_count, fn_ptr) create_native_fn(params, param_count, fn_ptr)
